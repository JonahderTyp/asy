...
if __name__ == "__main__":
    ...
    transformer = HomographyTransformer(src, dst)
    print("Homography H:\n", transformer.H)
    print("Mapped point:", transformer.map_point([1500, 1500]))
    pts = [[1200, 1100], [1800, 1900]]
    print("Batch mapping:", transformer.map_batch(pts))
